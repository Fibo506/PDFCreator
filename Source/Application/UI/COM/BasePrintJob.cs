...
public interface IBaseJobFinishedEvent
{
    void JobFinished();
}

public interface IBasePrintJob
{
    bool IsFinished { get; }
    ...
    BaseOutputFiles GetBaseOutputFiles { get; }
    ...
    BasePrintJobInfo BasePrintJobInfo { get; }
...
public class BasePrintJob : IBasePrintJob
{
    private static readonly Logger Logger = LogManager.GetCurrentClassLogger();

    private readonly PrintJobAdapter _printJobAdapter;

    public BasePrintJob(Job job, IJobInfoQueue comJobInfoQueue, IPrintJobAdapterFactory printJobAdapterFactory)
    {
    ...
    /// </summary>
    public BaseOutputFiles GetBaseOutputFiles => new BaseOutputFiles(_printJobAdapter.Job.OutputFiles);
    ...
    /// <summary>
    ///     Returns a BasePrintJobInfo object
    /// </summary>
    public BasePrintJobInfo BasePrintJobInfo => new BasePrintJobInfo(_printJobAdapter.Job.JobInfo.Metadata);
