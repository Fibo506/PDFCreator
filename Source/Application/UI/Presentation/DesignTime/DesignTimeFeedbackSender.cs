...
{
    public MultipartFormDataContent GetFormDataContent(string email, string feedbackText, FeedbackType selectedType, CompositeCollection uploadedFiles, string messageTitle)
    {
        return null;
    }
