...
public class DesignTimeAccountsViewModel : AccountsViewModel
{
    public DesignTimeAccountsViewModel() :
        base(new CurrentSettingsProvider(new NoGpoSettingsProvider()), null, new DesignTimeCommandLocator(), new DesignTimeTranslationUpdater(), new DispatcherWrapper(), null)
    {
