...
public abstract class Bootstrapper
{
    ...
    public void RegisterMainApplication(Container container)
    {
        ...
        container.RegisterSingleton<IShowHelpHelper, ShowHelpHelper>();
        ...
        container.RegisterInitializer<PDFCreatorDefaultSettingsBuilder>(x =>
        {
            ...
            x.EncryptionLevel = EditionHelper.IsFreeEdition ? EncryptionLevel.Aes128Bit : EncryptionLevel.Aes256Bit;
        });
    ...
    private void RegisterWebLinkLauncher(Container container)
    {
        ...
        container.RegisterSingleton(() => TrackingParameterReader.ReadFromRegistry(installationPathProvider.ApplicationRegistryPath));
        container.RegisterSingleton<IWebLinkLauncher, WebLinkLauncher>();
    }
