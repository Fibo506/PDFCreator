...
public class PrintFileHelperComFactory
{
    ...
    public ComPrintFileHelper CreatePrintFileHelperCom()
    {
        return new ComPrintFileHelper(_printerHelper, _settingsProvider, _fileAssoc, _file);
    }
}

public class ComPrintFileHelper : PrintFileHelperBase
{
    public ComPrintFileHelper(IPrinterHelper printerHelper, ISettingsProvider settingsProvider, IFileAssoc fileAssoc, IFile file) : base(printerHelper, settingsProvider, fileAssoc, file)
    {
    }
