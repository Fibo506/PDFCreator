...
public class JobRunner : IJobRunner
{
    ...
    private readonly IPreviewChangesHelper _previewChangesHelper;
    private readonly IEncryptedDocumentHelper _encryptedDocumentHelper;
    ...
    public JobRunner(ITokenReplacerFactory tokenReplacerFactory,
        ...
        IDirectoryHelper directoryHelper, IActionExecutor actionExecutor, IMergeBeforeActionsHelper mergeBeforeActionsHelper, IFailedJobHandler failedJobHandler, IPreviewChangesHelper previewChangesHelper, IEncryptedDocumentHelper encryptedDocumentHelper)
    {
        ...
        _encryptedDocumentHelper = encryptedDocumentHelper;
        _previewChangesHelper = previewChangesHelper;
    }
        ...
        catch (Exception ex)
        {
            ...
            switch (ex)
            {
                case ProcessingException processingException:
                    ...
                    errorCode = processingException.ErrorCode;
                    break;
            ...
            _failedJobHandler.HandleFailedJob(job, errorCode);
