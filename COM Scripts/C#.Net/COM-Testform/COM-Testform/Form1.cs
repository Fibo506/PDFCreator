...
namespace COM_TestForm
{
    public partial class Form1 : Form
    {
        ...
        private void coverPage_btn_Click(object sender, EventArgs e)
        {
            ...
            var coverPagePath = assemblyDir.Replace("\\bin\\Debug\\net8.0-windows\\COM-Testform.dll", "\\FilesForTests\\CoverPage.pdf");
        ...
        private void backgroundPage_btn_Click(object sender, EventArgs e)
        {
            ...
            var assemblyDir = Assembly.GetExecutingAssembly().Location;
            var bkgroundPagePath = assemblyDir.Replace("\\bin\\Debug\\net8.0-windows\\COM-Testform.dll", "\\FilesForTests\\BackgroundPage.pdf");
